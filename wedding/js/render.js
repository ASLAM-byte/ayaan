/* ============================================================
   WEDDING — Config-driven section rendering (shared by pages)
   Fills [data-render="..."] hosts if present on the page.
   ============================================================ */
(function () {
  "use strict";
  ...
  /* Dress-code swatches */
  mount("swatches", cfg.dressCode.swatches.map((sw) =>
  ...
  /* Story timeline (our-story page) */
  mount("timeline", (function () {
    const nodes = [];
    nodes.push(el(`<div class="timeline__spine" aria-hidden="true"><div class="timeline__progress"></div></div>`));
