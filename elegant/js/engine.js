/* ============================================================
   ELEGANT WEDDING — Motion engine (vanilla, GPU-friendly)
   ============================================================ */
(function () {
  "use strict";
  ...
  document.querySelectorAll("[data-reveal], .fade, .line-mask, .img-mask, [data-split], [data-stagger], .page-hero h1 .row, .hero__names .row, .hero__names .amp")
    .forEach((el) => (REDUCED ? el.classList.add("is-in") : io.observe(el)));

  /* Parallax + nav state + sticky timeline progress + scroll indicator */
