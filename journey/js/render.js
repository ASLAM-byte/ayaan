/* ============================================================
   JOURNEY WEDDING — Config-driven rendering + text binding
   Fills [data-render] hosts and [data-bind] / [data-i] hooks.
   ============================================================ */
(function () {
  "use strict";
  ...
  setTxt("[data-bind='quote']", cfg.couple.quote);
  ...
  mount("blog", cfg.blog.map((a) =>
    el(`<article class="article-card" data-cursor="READ">
      ...
      <a href="article.html?a=${a.slug}" class="ul meta" style="color:var(--plum)">Read story →</a>
    </article>`)
  ));
