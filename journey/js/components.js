/* ============================================================
   JOURNEY WEDDING — Interactive components
...
(function () {
  ...
  /* ---- RSVP form (validation + states + success) ---- */
  ...
  if (form) {
    ...
    form.addEventListener("submit", (ev) => {
      ...
      try { localStorage.setItem("journey_rsvp", JSON.stringify(data)); } catch (e) {}
      setTimeout(() => {
        if (success) {
