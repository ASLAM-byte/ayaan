// Serves the journey folder, verifies every page + asset resolves and key hooks exist.
...
const PORT = 4711, base = `http://localhost:${PORT}`;
let pass = 0, fail = 0;
...
server.listen(PORT, async () => {
  try {
    ...
    ok("home has countdown + rsvp form", home.text.includes("data-countdown") && home.text.includes("data-rsvp-form"));
    ...
    ok("config date drives countdown", cfg.text.includes('date: "2027-06-12"'));
