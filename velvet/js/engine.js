/* ============================================================
   VELVET PROMISE — Motion engine (vanilla, GPU-friendly)
   ============================================================ */
(function () {
  "use strict";
  ...
  function split(el) {
    ...
    const push = (val, cls) => {
      ...
      const i = document.createElement("span"); i.className = cls; i.textContent = val;
  ...
  document.querySelectorAll("[data-reveal], .fade, .line-mask, .img-mask, [data-split], [data-stagger], .page-hero h1 .row, .hero__title .row")
  ...
  if (!isTouch) {
    ...
    bind(); window.VP_bindCursor = bind;
  }

  window.VP = { REDUCED, isTouch, lerp };
})();
