# Sage — Editorial Wedding Microsite

An original, premium **editorial wedding website** — warm ivory backgrounds, muted sage & almond
...
(3:30 → 8:30) → live **countdown** → **RSVP** over a photograph (validation → in-place success
state) → **Gift Registry** (Wedding Registry + Honeymoon Fund) → **Wedding Blog** carousel →
...
section id is present, script order is correct, and config integrity holds. **21/21 checks pass.**
